...
9     ui(\textcolor{keyword}{new} Ui::VentanaPrincipal)
10 \{
11     ui->setupUi(\textcolor{keyword}{this});
12     ui->comboBox->addItem(\textcolor{stringliteral}{"Juvenil"});
13     ui->comboBox->addItem(\textcolor{stringliteral}{"Profesional"});
14     ui->comboBox->addItem(\textcolor{stringliteral}{"Experto"});
15     timer = \textcolor{keyword}{new} QTimer(\textcolor{keyword}{this});
16 
17     connect(timer, SIGNAL(timeout()), \textcolor{keyword}{this}, SLOT(tiempoFuera()));
18 \}
\end{DoxyCode}
